...
import ResponseCommentCell from '../ResponseCommentCell';
...
const Cell = styled(ResponseCommentCell)`
  margin: 10px 0;
...
export interface ResponseCommentTableInterface {
  items?: any;
  limit?: any;
  isShowMore?: any;
  setIsShowMore?: any;
...
const ResponseResponseTable = ({
  limit,
  isShowMore,
  setIsShowMore,
  items,
  history
}: ResponseCommentTableInterface) => (
  <Wrapper>
...
export default ResponseResponseTable;
